...
<div class="modal fade" id="modalTicket" tabindex="-1" aria-labelledby="modalTicketLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        <form action="<?= base_url('tickets/create_pro') ?>" method="POST" enctype="multipart/form-data">
...
<script type="text/javascript">
   $(document).ready(function() {
    var table = $('#dataTable').DataTable({
        ...
        "ajax": {
            url : "<?php echo site_url("tickets/tickets_page") ?>",
            type : 'POST',
            data : function ( d ) {
            }
        },
   ...
   function adicionarTicket() {
    $("#modal-body-ticket").load('<?= base_url('tickets/create') ?>');
}
